...
const testimonials = [
  {
    ...
    quote: 'I needed urgent court documents in Bahir Dar by morning. OmniRide matched me with a traveller leaving that afternoon. Documents arrived in 6 hours. Absolute lifesaver.',
    avatar: 'ST',
  ...
  },
  {
    ...
    quote: 'I travel Addis–Hawassa every weekend for family. OmniRide lets me earn 400–600 ETB per trip just by carrying packages I\'d have room for anyway. It\'s changed everything.',
    avatar: 'DH',
  ...
  },
  {
    ...
    role: 'Sender',
    roleColor: 'bg-amber-100 text-amber-700',
    quote: 'My mother sends traditional coffee and injera flour every month. Before OmniRide, getting it here was nearly impossible. Now it arrives fresh, every time.',
    avatar: 'MB',
